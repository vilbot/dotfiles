...
map('t', '<esc>', '<C-\\><C-n>')
map('t', '<C-w>', '<C-\\><C-n><C-w>')
map({'n', 't'}, '<leader>t', function() functions.open_term(nil) end)
map({'n', 't'}, '<leader>j', function() functions.open_term('belowright 15split') end)
map({'n', 't'}, '<leader>k', function() functions.open_term('vsplit') end)
